...
const _consoleTrace = console.info.bind(window.console, "%ctrace", "background-color: #EEE; color: #666;");
const _consoleInfo = console.info.bind(window.console, "%cinfo", "background-color: #DDF; color: #666;");

const _consoleReport = console.log.bind(window.console, "%creport", "background-color: #66F; color: white;");
const _consoleLog = console.log.bind(window.console, "%clog", "background-color: gray; color: white;");

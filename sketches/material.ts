...
export async function draw() {
    ...
    pbr.rect2(200, 0, 200, 200, metallicBlue);
    ...
    pbr.rect2(10, 210, 180, 180, embossedGray);
    ...
    pbr.rect2(210, 210, 180, 180, redLight);
    ...
    pbr.rect2(10, 410, 180, 80, defaultDemo);

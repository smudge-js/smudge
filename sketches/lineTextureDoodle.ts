...
export async function draw() {
  ...
  // load a texture
  const circleBrush = await smudge.loadTexture("images/circle_brush_soft.png");
  ...
  arcMat.metallic.color = 0;
  arcMat.albedo.color = [0.5, 0.1, 0.1, 1];
  smudge.rect(10, 10, 50, 50, arcMat);

  arcMat.albedo.color = [1, 0.1, 0.1, 1];
  smudge.rect(60, 10, 50, 50, arcMat);

  arcMat.albedo.color = [1.5, 0.1, 0.1, 1];
  smudge.rect(110, 10, 50, 50, arcMat);

  arcMat.albedo.color = [2, 0.1, 0.1, 1];
  smudge.rect(160, 10, 50, 50, arcMat);

  arcMat.albedo.color = [10, 0.1, 0.1, 1];
